...
:::caution[過去バージョン]
これは過去バージョン（v2.31）です。最新版は [v2.53](./thesis-v2-53/) をご覧ください。
:::
...
| Poseidon | データを固定長の値に変換する関数。ZKP処理を高速化するために設計された |
...
本システムでは、表3.9に示すように用途に応じて複数のハッシュアルゴリズムを使用している。
