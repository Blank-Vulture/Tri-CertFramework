...
![図2](/Users/pality/portfolio/Tri-CertFramework/docs/scripts/output/mermaid/mermaid-2.png)
...
![本研究の探究チャート](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/tankyu-chart.png)
...
![図1](/Users/pality/portfolio/Tri-CertFramework/docs/scripts/output/mermaid/mermaid-1.png)
...
![図3](/Users/pality/portfolio/Tri-CertFramework/docs/scripts/output/mermaid/mermaid-3.png)
...
![図4](/Users/pality/portfolio/Tri-CertFramework/docs/scripts/output/mermaid/mermaid-4.png)
...
![Registrar Console メイン画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/registrar-console/default.png)
...
![登録完了・アクティベーションコード表示画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/registrar-console/registar.png)
...
![学生削除確認画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/registrar-console/delete.png)
...
![CSV一括登録画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/registrar-console/csv_registar.png)
...
![Executive Console メイン画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/default.png)
...
![VK生成画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/vk_generator.png)
...
![VKバンドル生成完了](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/vk_generated.png)
...
![Ledger署名待機画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/waiting_sign_task.png)

<p align="center"><strong>図3.10: Ledger署名待機画面</strong></p>

![Ledger署名タスク受信](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/received_sign_task.png)

<p align="center"><strong>図3.11: Ledger署名タスク受信</strong></p>

Ledgerデバイスが接続されると、署名タスクがデバイスに送信される。

![署名詳細確認（1/2）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/sign_details_1.png)

<p align="center"><strong>図3.12: 署名詳細確認（1/2）</strong></p>

![署名詳細確認（2/2）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/sign_details_2.png)

<p align="center"><strong>図3.13: 署名詳細確認（2/2）</strong></p>

管理者はLedgerの画面でハッシュ値を確認し、物理ボタンで署名を承認する。

![署名確認](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/sign_confirm.png)

<p align="center"><strong>図3.14: 署名確認</strong></p>

![署名完了](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/hw-wallet/signed_message.png)
...
![署名処理ログ](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/executive-console/signing_logs/signing_log.png)
...
![Prover 初期画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/prover/default.png)
...
![アクティベーションコード入力画面（入力前）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/prover/input_before.png)
...
![アクティベーションコード入力画面（入力後）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/prover/input_after.png)
...
![WebAuthn認証ダイアログ](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/prover/webauthn_dialog.png)
...
![証明生成完了画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/prover/output.png)
...
![Verifier UI 初期画面](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/default.png)
...
![検証プロセス表示](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/verified_1.png)
...
![検証成功画面（詳細情報）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/verified_2.png)
...
![検証結果の説明](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/explain_output.png)
...
![検証失敗画面（概要）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/failure_verified_1.png)

<p align="center"><strong>図3.26: 検証失敗画面（概要）</strong></p>

![検証失敗画面（詳細）](/Users/pality/portfolio/Tri-CertFramework/docs/src/assets/screenshot/verifier/failure_verified_2.png)
