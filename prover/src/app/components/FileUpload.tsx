...
export default function FileUpload({ onFileSelect, selectedFile }: FileUploadProps) {
  ...
  return (
    <div className="space-y-6">
      {!selectedFile ? (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('fileUpload.title')}</h3>
          <div
            onDrop={handleDrop}
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-500 mt-1">{t('fileUpload.orDrop')}</p>
                  </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">{t('fileUpload.documentReady')}</h3>
